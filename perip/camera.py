...
def main():
    ...
    if sys.platform == "linux" and "microsoft" in platform.release().lower():
        ...
        if not python.exists():
            raise RuntimeError("Falta .venv-win. Ejecuta python3 setup.py desde perip.")
    ...
    try:
        ...
        raise RuntimeError("Faltan dependencias. Ejecuta python3 setup.py desde perip.") from exc
