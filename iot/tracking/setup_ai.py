...
def main():
    ...
    emotion_detector = ROOT.parents[1] / 'ai' / 'comp_vision' / 'emotion-detector'
    subprocess.run([str(python), '-m', 'pip', 'install', '-r',
                    win(emotion_detector / 'requirements-windows.txt')], check=True)
    print('Listo. Ejecuta python3 tracking.py desde iot/tracking.')
